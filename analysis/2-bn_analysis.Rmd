...
pdf ("../manuscript_bn/fig1.pdf", width = 10, height = 7)
df_plot
dev.off()
...
pdf ("../manuscript_bn/fig2.pdf", width = 10, height = 7)
...
pdf ("../manuscript_bn/fig3.pdf", width = 6, height = 5)
df_plot
dev.off()
```
...
pdf ("../manuscript_bn/fig4.pdf", width = 6, height = 5)
sim %>%
...
pdf ("../manuscript_bn/fig5.pdf", width = 6, height = 5)
sim %>%
