...
f <- plot (edge_wts, satistics = "edge", order = "sample")
wts
```
...
```{r}
p_val <- plot (edge_wts, plot = "difference", satistics = "edge", order = "sample", onlyNonZero = TRUE)
```
...
```{r, eval = FALSE}
tiff(width = 15, height = 15, units = "in", res = 100, file = "../manuscript/fig_4.tiff")
